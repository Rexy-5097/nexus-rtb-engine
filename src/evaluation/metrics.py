...
def calculate_metrics(
    ...
    budget_util = total_spend  # Absolute spend, utilization depends on budget cap which is external
    
    # Efficiency
    cpm = (total_spend / total_wins) * 1000 if total_wins > 0 else 0.0 # Cost per 1000 impressions
    ...
    score_spend_ratio = total_value / total_spend if total_spend > 0 else 0.0 # Value is Score in this context?
