...
from src.bidding.engine import BiddingEngine  # noqa: E402
from src.bidding.features import \
    FeatureExtractor as RealFeatureExtractor  # noqa: E402
from src.bidding.model import ModelLoader  # noqa: E402
from src.bidding.schema import BidRequest  # noqa: E402
        ...
        if resp.bidPrice > 0:
            ...
            if resp.bidPrice >= market_price:
                ...
                with engine.pacing._lock:
                    ...
                    if engine.pacing._win_history:
                        engine.pacing._win_history[-1] = 1
            else:
                # Lose
                diff = 0.0 - reserved
                with engine.pacing._lock:
